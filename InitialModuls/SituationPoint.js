    export class SituationPoint {
        ...
        showSituationPoints(pointsList) {
            ...
            pointsList.forEach(point => {
                ...
                // Логування коду іконки перед кодуванням у Base64
                console.log('SVG Code before encoding:', point.icon);

                const encodedSvg = 'data:image/svg+xml;base64,' + btoa(point.icon);

                // Логування закодованого SVG перед його використанням
                console.log('Encoded SVG for img src:', encodedSvg);

                iconImg.src = encodedSvg;
